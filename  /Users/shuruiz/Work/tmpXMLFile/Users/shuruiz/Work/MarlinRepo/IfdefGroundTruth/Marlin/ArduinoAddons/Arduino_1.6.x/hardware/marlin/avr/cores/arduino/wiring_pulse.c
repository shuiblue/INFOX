...
unknowntype long pulseIn(uint8_t pin, uint8_t state, unknowntype long timeout)
{
	...
	unknowntype long width = 0; // keep initialization out of time critical area
	
	// convert the timeout from microseconds to a number of times through
	// the initial loop; it takes 16 clock cycles per iteration.
	unknowntype long numloops = 0;
	unknowntype long maxloops = microsecondsToClockCycles(timeout) / 16;
	...
	// Conversion ants are compiler-dependent, different compiler versions
