...
// HardwareSerial ructor also works, but makes the code bigger and
// slower.
#if !defined(TXC0)
#if defined(TXC)
...
void HardwareSerial::_rx_complete_irq(void)
{
  if (bit_is_clear(*_ucsra, UPE0)) {
    ...
    // room
    unknowntype char c = *_udr;
    rx_buffer_index_t i = (unknowntype int)(_rx_buffer_head + 1) % SERIAL_RX_BUFFER_SIZE;
