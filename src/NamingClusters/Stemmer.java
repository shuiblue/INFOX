...
public class Stemmer {
   ...
   */
    ...
    private final void step1() {
        ...
        if (ends("eed")) {
            if (m() > 0) k--;
        } else if ((ends("ed") || ends("ing") || ends("es")) && vowelinstem()) {
            k = j;
   ...
   /* step6() removes a final -e if m() > 1. */
    ...
    /**
     * This function stem a word to its root
     * @param word
     * @return root of the word
     */
    public static String stemmingAWord(String word) {
    ...
    public static void stemmingFile(String filePath) {
        char[] w = new char[501];
        Stemmer s = new Stemmer();
        try {
