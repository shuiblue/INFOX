<script src = "https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"> </script>
    ...
    <script src = "https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" ></script>git
...
function hide_non_cluster_rows() {
    ...
    if (btn.innerHTML == "Hide non cluster code") {
        btn.innerHTML = "Show non cluster code"
    }
    else {
...
function hide_cluster_rows(button_id) {
    var el = document.getElementById(button_id);
    if (el.firstChild.data == "hide") {
        el.firstChild.data = "shown";
    }
    else {
        el.firstChild.data = "hide";
    }
    var cluster_id = button_id.replace("_button", "");
